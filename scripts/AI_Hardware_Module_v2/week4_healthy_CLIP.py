...
# 图片文件名（手动指定五张健康的照片）
image_files = ["6.jpg", "7.jpg", "8.jpg", "9.jpg", "10.jpg"]  # 假设健康的图片名为6.jpg到10.jpg
...
if results:
    ...
    output_results_path = os.path.join(BASE_DIR, "logs", "healthy_detection_results.xlsx")  # 改名为healthy测试
...
if results and len(results) == 5:
    ...
    plt.title("Healthy Crop Detection Accuracy Heatmap")  # 改标题为healthy测试
    output_heatmap_path = os.path.join(OUTPUT_DIR, "healthy_heatmap.png")  # 改热图文件名
